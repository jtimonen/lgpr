---
title: "Easy way to create and modify your input data frame for lgpr"
author: "Juho Timonen"
date: "`r Sys.Date()`"
output: 
...
#    toc: true     
vignette: >
  %\VignetteIndexEntry{Easy way to create and modify your input data frame for lgpr}
...
data <- add_diseaseAges(data, t_init)
```
...
plot_data(data, highlight = 'sex', response = "y")
```

```{r plot2, fig.width=6.6, fig.height=4}
plot_data(data, highlight = 'diseaseAge', response = "y")
```