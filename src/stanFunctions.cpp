...
namespace user_7545dfa196dcb8dec6cd564e6a96bdc6 { 
using std::istream;
using std::string;
...
STAN_vectorsum(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >& vecs,
  ...
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_vectorsum<double>(vecs, L, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_warp_input(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
  ...
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_warp_input<double, double>(x, a, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_var_mask(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
                  const double& a, std::ostream* pstream__ = 0){
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_var_mask<double, double>(x, a, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_expand(const Eigen::Matrix<double, Eigen::Dynamic, 1>& v,
  ...
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_expand<double>(v, idx_expand, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_edit_x_cont(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x_cont,
  ...
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_edit_x_cont<double, double, double>(x_cont, idx_expand, teff_obs, teff, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_base_zerosum(const std::vector<int>& x1,
  ...
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_kernel_base_zerosum(x1, x2, num_cat, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_base_cat(const std::vector<int>& x1,
  ...
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_kernel_base_cat(x1, x2, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_base_bin_mask(const std::vector<int>& x1,
                              const std::vector<int>& x2, std::ostream* pstream__ = 0){
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_kernel_base_bin_mask(x1, x2, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_const(const std::vector<int>& x1,
                      ...
                      const int& num_cat, std::ostream* pstream__ = 0){
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_kernel_const(x1, x2, kernel_type, num_cat, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >
STAN_kernel_const_all(const int& n1,
  ...
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_kernel_const_all(n1, n2, x1, x2, x1_mask, x2_mask, num_levels, components, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_base_var_mask(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x1,
  ...
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_kernel_base_var_mask<double, double, double, double>(x1, x2, steepness, vm_params, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >
STAN_kernel_all(const int& n1,
  ...
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_kernel_all<double, double, double, double, double, double, double, double, double, double, double, double>(n1, n2, K_const, components, x1, x2, x1_unnorm, x2_unnorm, alpha, ell, wrp, beta, teff, vm_params, idx1_expand, idx2_expand, teff_zero, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_bfa_phi(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
                 const int& m,
                 const double& L, std::ostream* pstream__ = 0){
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_bfa_phi<double, double>(x, m, L, pstream__);
}
// [[Rcpp::export]]
double
STAN_bfa_lambda(const int& m,
                    const double& L, std::ostream* pstream__ = 0){
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_bfa_lambda<double>(m, L, pstream__);
}
// [[Rcpp::export]]
double
STAN_spd_eq(const double& w,
  ...
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_spd_eq<double, double, double>(w, alpha, ell, pstream__);
}
// [[Rcpp::export]]
double
STAN_quad_form_inv(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
  ...
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_quad_form_inv<double, double>(x, A, pstream__);
}
// [[Rcpp::export]]
double
STAN_bfa_multi_normal_lpdf(const Eigen::Matrix<double, Eigen::Dynamic, 1>& y,
  ...
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_bfa_multi_normal_lpdf<false, double, double, double, double>(y, V, D_diag, sigma, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >
STAN_bfa_Phi(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >& x,
                 const int& M,
                 const double& L, std::ostream* pstream__ = 0){
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_bfa_Phi<double, double>(x, M, L, pstream__);
...
STAN_bfa_Lambda(const std::vector<double>& alpha,
                    const std::vector<double>& ell,
                    const int& M,
                    const double& L, std::ostream* pstream__ = 0){
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_bfa_Lambda<double, double, double>(alpha, ell, M, L, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_matrix_array_sum(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >& K, std::ostream* pstream__ = 0){
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_matrix_array_sum<double>(K, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >
STAN_gp_posterior_helper(const Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>& Ly,
  ...
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_gp_posterior_helper<double, double, double, double>(Ly, K_s, K_ss, v, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >
STAN_gp_posterior(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >& KX,
                      ...
                      const double& sigma, std::ostream* pstream__ = 0){
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_gp_posterior<double, double, double, double, double, double>(KX, KX_s, KX_ss, y, delta, sigma, pstream__);
}
// [[Rcpp::export]]
double
STAN_log_prior(const double& x,
  ...
  return 
user_7545dfa196dcb8dec6cd564e6a96bdc6::STAN_log_prior<double, double>(x, types, p, pstream__);
}
