...
namespace user_12ac55596c77ad47a5a451c7a3abf9b1 { 
using std::istream;
using std::string;
...
template <typename T1__, typename T3__, typename T4__, typename T5__, typename T6__, typename T7__, typename T8__, typename T9__, typename T12__>
std::vector<Eigen::Matrix<typename boost::math::tools::promote_args<T1__, T3__, T4__, T5__, typename boost::math::tools::promote_args<T6__, T7__, T8__, T9__, typename boost::math::tools::promote_args<T12__>::type>::type>::type, Eigen::Dynamic, 1> >
STAN_kernel_all_diag(const int& n,
                         ...
                         const std::vector<Eigen::Matrix<T8__, Eigen::Dynamic, 1> >& xpar,
                         const std::vector<T9__>& vm_params,
                         const std::vector<std::vector<int> >& beta_idx,
                         const std::vector<std::vector<int> >& xpar_idx,
                         const std::vector<Eigen::Matrix<T12__, Eigen::Dynamic, 1> >& xpar_zero, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T1__, T3__, T4__, T5__, typename boost::math::tools::promote_args<T6__, T7__, T8__, T9__, typename boost::math::tools::promote_args<T12__>::type>::type>::type local_scalar_t__;
    typedef local_scalar_t__ fun_return_scalar_t__;
    const static bool propto__ = true;
    (void) propto__;
        local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
        ...
        for (int j = 1; j <= J; ++j) {
            ...
            if (as_bool(logical_neq(idx_cont, 0))) {
                ...
                if (as_bool(has_unc)) {
                    ...
                    stan::math::assign(x, STAN_edit_x_cont(x, get_base1(xpar_idx, 1, "xpar_idx", 1), get_base1(xpar_zero, 1, "xpar_zero", 1), get_base1(xpar, 1, "xpar", 1), pstream__));
                }
...
struct STAN_kernel_all_diag_functor__ {
    ...
    operator()(const int& n,
                         ...
                         const std::vector<std::vector<int> >& beta_idx,
                         const std::vector<std::vector<int> >& xpar_idx,
                         const std::vector<Eigen::Matrix<T12__, Eigen::Dynamic, 1> >& xpar_zero, std::ostream* pstream__) const {
        return STAN_kernel_all_diag(n, K_const_diag, components, X, X_scale, alpha, wrp, beta, xpar, vm_params, beta_idx, xpar_idx, xpar_zero, pstream__);
    }
};
...
STAN_vectorsum(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >& vecs,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_vectorsum<double>(vecs, L, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_matrix_array_sum(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >& K, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_matrix_array_sum<double>(K, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_warp_input(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_warp_input<double, double>(x, a, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_var_mask(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
                  const double& a, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_var_mask<double, double>(x, a, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_expand(const Eigen::Matrix<double, Eigen::Dynamic, 1>& v,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_expand<double>(v, idx_expand, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_edit_x_cont(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x_cont,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_edit_x_cont<double, double, double>(x_cont, idx_expand, teff_obs, teff, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_zerosum(const std::vector<int>& x1,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_zerosum(x1, x2, num_cat, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_cat(const std::vector<int>& x1,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_cat(x1, x2, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_bin(const std::vector<int>& x1,
                    const std::vector<int>& x2, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_bin(x1, x2, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_const(const std::vector<int>& z1,
                      ...
                      const int& num_cat, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_const(z1, z2, kernel_type, num_cat, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >
STAN_kernel_const_all(const int& n1,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_const_all(n1, n2, Z1, Z2, X1_mask, X2_mask, num_levels, components, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_eq(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x1,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_eq<double, double, double, double>(x1, x2, alpha, ell, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_varmask(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x1,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_varmask<double, double, double, double>(x1, x2, steepness, vm_params, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_beta(const Eigen::Matrix<double, Eigen::Dynamic, 1>& beta,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_beta<double>(beta, idx1_expand, idx2_expand, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >
STAN_kernel_all(const int& n1,
                    ...
                    const std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >& xpar,
                    const std::vector<double>& vm_params,
                    const std::vector<std::vector<int> >& beta_idx1,
                    const std::vector<std::vector<int> >& beta_idx2,
                    const std::vector<std::vector<int> >& xpar_idx1,
                    const std::vector<std::vector<int> >& xpar_idx2,
                    const std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >& xpar_zero, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_all<double, double, double, double, double, double, double, double, double, double, double>(n1, n2, K_const, components, X1, X2, X_scale, alpha, ell, wrp, beta, xpar, vm_params, beta_idx1, beta_idx2, xpar_idx1, xpar_idx2, xpar_zero, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_kernel_const_diag(const std::vector<int>& z,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_const_diag(z, kernel_type, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >
STAN_kernel_const_all_diag(const int& P,
                               ...
                               const std::vector<std::vector<int> >& components, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_const_all_diag(P, Z, X_mask, components, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_kernel_eq_diag(const int& n,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_eq_diag<double>(n, alpha, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_kernel_varmask_diag(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
                             ...
                             const std::vector<double>& vm_params, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_varmask_diag<double, double, double>(x, steepness, vm_params, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_kernel_beta_diag(const Eigen::Matrix<double, Eigen::Dynamic, 1>& beta,
                          const std::vector<int>& idx_expand, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_beta_diag<double>(beta, idx_expand, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >
STAN_kernel_all_diag(const int& n,
                         ...
                         const std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >& xpar_zero, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_kernel_all_diag<double, double, double, double, double, double, double, double, double>(n, K_const_diag, components, X, X_scale, alpha, wrp, beta, xpar, vm_params, beta_idx, xpar_idx, xpar_zero, pstream__);
}
// [[Rcpp::export]]
double
STAN_log_prior(const double& x,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_log_prior<double, double>(x, types, p, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_rep_vector_times(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_rep_vector_times<double>(x, J, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_rep_vector_each(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
                         const int& J, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_rep_vector_each<double>(x, J, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_rep_cols_times(const Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>& X,
                        const int& J, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_rep_cols_times<double>(X, J, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_rep_cols_each(const Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>& X,
                       const int& J, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_rep_cols_each<double>(X, J, pstream__);
}
// [[Rcpp::export]]
double
STAN_quad_form_inv(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_quad_form_inv<double, double>(x, A, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_phi(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_phi<double, double>(x, m, L, pstream__);
}
// [[Rcpp::export]]
double
STAN_lambda(const int& m,
                const double& L, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_lambda<double>(m, L, pstream__);
}
// [[Rcpp::export]]
double
STAN_spd_eq(const double& w,
                const double& ell, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_spd_eq<double, double>(w, ell, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >
STAN_phi_matrix(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >& x,
                    ...
                    const std::vector<std::vector<int> >& components, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_phi_matrix<double, double>(x, M, L, components, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >
STAN_lambda_matrix(const std::vector<double>& ell,
                       ...
                       const std::vector<std::vector<int> >& components, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_lambda_matrix<double, double>(ell, M, L, components, pstream__);
}
// [[Rcpp::export]]
std::vector<int>
STAN_ranks(const std::vector<std::vector<int> >& components,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_ranks(components, x_cat_num_levels, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_delta_matrix(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >& K_const,
                      ...
                      const std::vector<std::vector<int> >& components, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_delta_matrix<double>(K_const, ranks, components, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_theta_matrix(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >& K_const,
                      ...
                      const std::vector<std::vector<int> >& components, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_theta_matrix<double>(K_const, ranks, components, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_D_matrix(const std::vector<double>& alpha,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_D_matrix<double, double, double>(alpha, bfa_lambda, bfa_delta, ranks, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_V_matrix(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >& bfa_phi,
                  ...
                  const std::vector<int>& ranks, std::ostream* pstream__ = 0){
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_V_matrix<double, double>(bfa_phi, bfa_theta, ranks, pstream__);
}
// [[Rcpp::export]]
double
STAN_multi_normal_bfa_logpdf(const Eigen::Matrix<double, Eigen::Dynamic, 1>& y,
  ...
  return 
user_12ac55596c77ad47a5a451c7a3abf9b1::STAN_multi_normal_bfa_logpdf<double, double, double, double>(y, V, D_diag, sigma, pstream__);
}
