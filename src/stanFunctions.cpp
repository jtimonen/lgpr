...
namespace user_7f0875329675afdd745c59ada7e4e1f1 { 
using std::istream;
using std::string;
...
STAN_rep_vector_times(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_rep_vector_times<double>(x, J, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_rep_vector_each(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
                         const int& J, std::ostream* pstream__ = 0){
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_rep_vector_each<double>(x, J, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_rep_cols_times(const Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>& X,
                        const int& J, std::ostream* pstream__ = 0){
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_rep_cols_times<double>(X, J, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_rep_cols_each(const Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>& X,
                       const int& J, std::ostream* pstream__ = 0){
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_rep_cols_each<double>(X, J, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_vectorsum(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >& vecs,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_vectorsum<double>(vecs, L, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_warp_input(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_warp_input<double, double>(x, a, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_var_mask(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
                  const double& a, std::ostream* pstream__ = 0){
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_var_mask<double, double>(x, a, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_expand(const Eigen::Matrix<double, Eigen::Dynamic, 1>& v,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_expand<double>(v, idx_expand, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_edit_x_cont(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x_cont,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_edit_x_cont<double, double, double>(x_cont, idx_expand, teff_obs, teff, pstream__);
}
// [[Rcpp::export]]
double
STAN_quad_form_inv(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_quad_form_inv<double, double>(x, A, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_base_zerosum(const std::vector<int>& x1,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_kernel_base_zerosum(x1, x2, num_cat, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_base_cat(const std::vector<int>& x1,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_kernel_base_cat(x1, x2, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_base_bin_mask(const std::vector<int>& x1,
                              const std::vector<int>& x2, std::ostream* pstream__ = 0){
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_kernel_base_bin_mask(x1, x2, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_const(const std::vector<int>& x1,
                      ...
                      const int& num_cat, std::ostream* pstream__ = 0){
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_kernel_const(x1, x2, kernel_type, num_cat, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >
STAN_kernel_const_all(const int& n1,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_kernel_const_all(n1, n2, x1, x2, x1_mask, x2_mask, num_levels, components, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_kernel_base_var_mask(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x1,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_kernel_base_var_mask<double, double, double, double>(x1, x2, steepness, vm_params, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >
STAN_kernel_all(const int& n1,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_kernel_all<double, double, double, double, double, double, double, double, double, double, double, double>(n1, n2, K_const, components, x1, x2, x1_unnorm, x2_unnorm, alpha, ell, wrp, beta, teff, vm_params, idx1_expand, idx2_expand, teff_zero, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_phi(const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_phi<double, double>(x, m, L, pstream__);
}
// [[Rcpp::export]]
double
STAN_lambda(const int& m,
                const double& L, std::ostream* pstream__ = 0){
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_lambda<double>(m, L, pstream__);
}
// [[Rcpp::export]]
double
STAN_spd_eq(const double& w,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_spd_eq<double, double>(w, ell, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >
STAN_phi_matrix(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >& x,
                    ...
                    const std::vector<std::vector<int> >& components, std::ostream* pstream__ = 0){
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_phi_matrix<double, double>(x, M, L, components, pstream__);
}
// [[Rcpp::export]]
...
STAN_lambda_matrix(const std::vector<double>& ell,
                       ...
                       const std::vector<std::vector<int> >& components, std::ostream* pstream__ = 0){
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_lambda_matrix<double, double>(ell, M, L, components, pstream__);
}
// [[Rcpp::export]]
std::vector<int>
STAN_ranks(const std::vector<std::vector<int> >& components,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_ranks(components, x_cat_num_levels, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_delta_matrix(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >& K_const,
                      ...
                      const std::vector<std::vector<int> >& components, std::ostream* pstream__ = 0){
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_delta_matrix<double>(K_const, ranks, components, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_theta_matrix(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >& K_const,
                      ...
                      const std::vector<std::vector<int> >& components, std::ostream* pstream__ = 0){
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_theta_matrix<double>(K_const, ranks, components, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
STAN_D_matrix(const std::vector<double>& alpha,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_D_matrix<double, double, double>(alpha, bfa_lambda, bfa_delta, ranks, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_V_matrix(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >& bfa_phi,
                  ...
                  const std::vector<int>& ranks, std::ostream* pstream__ = 0){
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_V_matrix<double, double>(bfa_phi, bfa_theta, ranks, pstream__);
}
// [[Rcpp::export]]
double
STAN_multi_normal_bfa_logpdf(const Eigen::Matrix<double, Eigen::Dynamic, 1>& y,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_multi_normal_bfa_logpdf<double, double, double, double>(y, V, D_diag, sigma, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
STAN_matrix_array_sum(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >& K, std::ostream* pstream__ = 0){
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_matrix_array_sum<double>(K, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >
STAN_gp_posterior_helper(const Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>& Ly,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_gp_posterior_helper<double, double, double, double>(Ly, K_s, K_ss, v, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >
STAN_gp_posterior(const std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >& KX,
                      ...
                      const double& sigma, std::ostream* pstream__ = 0){
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_gp_posterior<double, double, double, double, double, double>(KX, KX_s, KX_ss, y, delta, sigma, pstream__);
}
// [[Rcpp::export]]
double
STAN_log_prior(const double& x,
  ...
  return 
user_7f0875329675afdd745c59ada7e4e1f1::STAN_log_prior<double, double>(x, types, p, pstream__);
}
