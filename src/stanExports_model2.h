...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(243, 63, "end", "chunks/data.stan");
    reader.add_event(243, 12, "restart", "model_model2");
    reader.add_event(258, 27, "include", "covariance/fixed.stan");
    reader.add_event(258, 0, "start", "covariance/fixed.stan");
    reader.add_event(273, 15, "end", "covariance/fixed.stan");
    reader.add_event(273, 28, "restart", "model_model2");
    reader.add_event(273, 28, "include", "chunks/info.stan");
    reader.add_event(273, 0, "start", "chunks/info.stan");
    reader.add_event(291, 18, "end", "chunks/info.stan");
    reader.add_event(291, 29, "restart", "model_model2");
    reader.add_event(297, 35, "include", "chunks/parameters.stan");
    reader.add_event(297, 0, "start", "chunks/parameters.stan");
    reader.add_event(316, 19, "end", "chunks/parameters.stan");
    reader.add_event(316, 36, "restart", "model_model2");
    reader.add_event(323, 43, "include", "covariance/additive.stan");
    reader.add_event(323, 0, "start", "covariance/additive.stan");
    reader.add_event(355, 32, "end", "covariance/additive.stan");
    reader.add_event(355, 44, "restart", "model_model2");
    reader.add_event(369, 58, "include", "chunks/priors.stan");
    reader.add_event(369, 0, "start", "chunks/priors.stan");
    reader.add_event(422, 53, "end", "chunks/priors.stan");
    reader.add_event(422, 59, "restart", "model_model2");
    reader.add_event(429, 66, "include", "likelihood/sampled.stan");
    reader.add_event(429, 0, "start", "likelihood/sampled.stan");
    reader.add_event(451, 22, "end", "likelihood/sampled.stan");
    reader.add_event(451, 67, "restart", "model_model2");
    reader.add_event(455, 69, "end", "model_model2");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            pos__ = 0;
            LH = vals_i__[pos__++];
            check_greater_or_equal(function__, "LH", LH, 1);
            ...
            validate_non_negative_index("sigma_n", "logical_eq(LH, 1)", logical_eq(LH, 1));
            num_params_r__ += (1 * logical_eq(LH, 1));
            current_statement_begin__ = 296;
            validate_non_negative_index("phi", "logical_eq(LH, 3)", logical_eq(LH, 3));
            num_params_r__ += (1 * logical_eq(LH, 3));
            current_statement_begin__ = 297;
            validate_non_negative_index("ETA", "n", n);
            validate_non_negative_index("ETA", "sum_D", sum_D);
            num_params_r__ += (n * sum_D);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("sigma_n", "logical_eq(LH, 1)", logical_eq(LH, 1));
        context__.validate_dims("parameter initialization", "sigma_n", "double", context__.to_vec(logical_eq(LH, 1)));
        std::vector<double> sigma_n(logical_eq(LH, 1), double(0));
        size_t sigma_n_k_0_max__ = logical_eq(LH, 1);
        for (size_t k_0__ = 0; k_0__ < sigma_n_k_0_max__; ++k_0__) {
            sigma_n[k_0__] = vals_r__[pos__++];
        }
        size_t sigma_n_i_0_max__ = logical_eq(LH, 1);
        ...
        pos__ = 0U;
        validate_non_negative_index("phi", "logical_eq(LH, 3)", logical_eq(LH, 3));
        context__.validate_dims("parameter initialization", "phi", "double", context__.to_vec(logical_eq(LH, 3)));
        std::vector<double> phi(logical_eq(LH, 3), double(0));
        size_t phi_k_0_max__ = logical_eq(LH, 3);
        for (size_t k_0__ = 0; k_0__ < phi_k_0_max__; ++k_0__) {
            phi[k_0__] = vals_r__[pos__++];
        }
        size_t phi_i_0_max__ = logical_eq(LH, 3);
        ...
        validate_non_negative_index("ETA", "n", n);
        validate_non_negative_index("ETA", "sum_D", sum_D);
        context__.validate_dims("parameter initialization", "ETA", "vector_d", context__.to_vec(sum_D,n));
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > ETA(sum_D, Eigen::Matrix<double, Eigen::Dynamic, 1>(n));
        size_t ETA_j_1_max__ = n;
        size_t ETA_k_0_max__ = sum_D;
        for (size_t j_1__ = 0; j_1__ < ETA_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < ETA_k_0_max__; ++k_0__) {
                ETA[k_0__](j_1__) = vals_r__[pos__++];
            }
        }
        size_t ETA_i_0_max__ = sum_D;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            size_t sigma_n_d_0_max__ = logical_eq(LH, 1);
            ...
            size_t phi_d_0_max__ = logical_eq(LH, 3);
            ...
            validate_non_negative_index("F", "1", 1);
            validate_non_negative_index("F", "sum_D", sum_D);
            std::vector<std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > > F(1, std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> >(sum_D, Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1>(n)));
            ...
            if (as_bool(logical_eq(get_base1(D, 1, "D", 1), 1))) {
                ...
                stan::model::assign(KX, 
                            ...
                            elt_multiply(cov_exp_quad(x_age, get_base1(alpha_idAge, 1, "alpha_idAge", 1), get_base1(ell_idAge, 1, "ell_idAge", 1)), get_base1(KF, 1, "KF", 1)), 
            ...
            if (as_bool(logical_eq(get_base1(D, 2, "D", 1), 1))) {
                ...
                stan::model::assign(KX, 
                            stan::model::cons_list(stan::model::index_uni(r), stan::model::nil_index_list()), 
                            cov_exp_quad(x_age, get_base1(alpha_sharedAge, 1, "alpha_sharedAge", 1), get_base1(ell_sharedAge, 1, "ell_sharedAge", 1)), 
                            "assigning variable KX");
            }
            ...
            if (as_bool(logical_eq(get_base1(D, 3, "D", 1), 1))) {
                ...
                stan::model::assign(KX, 
                            stan::model::cons_list(stan::model::index_uni(r), stan::model::nil_index_list()), 
                            STAN_K_disease(get_base1(X, 3, "X", 1), get_base1(KF, 2, "KF", 1), alpha_diseaseAge, ell_diseaseAge, warp_steepness, vm_params, beta, USE_VAR_MASK, UNCRT, HMGNS, T_effect, T_observed, caseID_to_rows, row_to_caseID_plus1, caseID_nrows, pstream__), 
                            "assigning variable KX");
            }
            ...
            for (int j = 1; j <= get_base1(D, 4, "D", 1); ++j) {
                ...
                stan::model::assign(KX, 
                            stan::model::cons_list(stan::model::index_uni(r), stan::model::nil_index_list()), 
                            cov_exp_quad(to_array_1d(get_base1(X, ix, "X", 1)), get_base1(alpha_continuous, j, "alpha_continuous", 1), get_base1(ell_continuous, j, "ell_continuous", 1)), 
                            "assigning variable KX");
            }
            ...
            for (int j = 1; j <= get_base1(D, 5, "D", 1); ++j) {
                ...
                stan::model::assign(KX, 
                            stan::model::cons_list(stan::model::index_uni(r), stan::model::nil_index_list()), 
                            elt_multiply(cov_exp_quad(x_age, get_base1(alpha_categAge, j, "alpha_categAge", 1), get_base1(ell_categAge, j, "ell_categAge", 1)), get_base1(KF, ikf, "KF", 1)), 
                            "assigning variable KX");
            }
            ...
            for (int j = 1; j <= get_base1(D, 6, "D", 1); ++j) {
                ...
                stan::model::assign(KX, 
                            stan::model::cons_list(stan::model::index_uni(r), stan::model::nil_index_list()), 
                            multiply(square(get_base1(alpha_categOffset, j, "alpha_categOffset", 1)), get_base1(KF, ikf, "KF", 1)), 
                            "assigning variable KX");
            }
            }
            ...
            for (int j = 1; j <= sum_D; ++j) {
                ...
                stan::model::assign(F, 
                            ...
                            multiply(cholesky_decompose(add(get_base1(KX, j, "KX", 1), EYE)), get_base1(ETA, j, "ETA", 1)), 
            ...
            (void) function__;  // dummy to suppress unused var warning
            current_statement_begin__ = 320;
            size_t KX_k_0_max__ = sum_D;
            size_t KX_j_1_max__ = n;
            size_t KX_j_2_max__ = n;
            for (size_t k_0__ = 0; k_0__ < KX_k_0_max__; ++k_0__) {
                for (size_t j_1__ = 0; j_1__ < KX_j_1_max__; ++j_1__) {
                    for (size_t j_2__ = 0; j_2__ < KX_j_2_max__; ++j_2__) {
                        if (stan::math::is_uninitialized(KX[k_0__](j_1__, j_2__))) {
                            std::stringstream msg__;
                            msg__ << "Undefined transformed parameter: KX" << "[" << k_0__ << "]" << "(" << j_1__ << ", " << j_2__ << ")";
                            stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable KX: ") + msg__.str()), current_statement_begin__, prog_reader__());
                        }
                    }
                }
            }
            current_statement_begin__ = 321;
            size_t F_k_0_max__ = 1;
            ...
            if (as_bool(logical_eq(SKIP_LH, 0))) {
                {
    ...
    void get_dims(std::vector<std::vector<size_t> >& dimss__) const {
        ...
        dims__.resize(0);
        dims__.push_back(logical_eq(LH, 1));
        dimss__.push_back(dims__);
        dims__.resize(0);
        dims__.push_back(logical_eq(LH, 3));
        dimss__.push_back(dims__);
        dims__.resize(0);
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            validate_non_negative_index("KX", "n", n);
            validate_non_negative_index("KX", "sum_D", sum_D);
            std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> > KX(sum_D, Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n, n));
            stan::math::initialize(KX, DUMMY_VAR__);
            stan::math::fill(KX, DUMMY_VAR__);
            current_statement_begin__ = 321;
            validate_non_negative_index("F", "n", n);
            validate_non_negative_index("F", "1", 1);
            validate_non_negative_index("F", "sum_D", sum_D);
            std::vector<std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > > F(1, std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >(sum_D, Eigen::Matrix<double, Eigen::Dynamic, 1>(n)));
            stan::math::initialize(F, DUMMY_VAR__);
            stan::math::fill(F, DUMMY_VAR__);
            current_statement_begin__ = 322;
            validate_non_negative_index("T_effect", "N_cases", N_cases);
            ...
            if (include_tparams__) {
                ...
                for (size_t j_2__ = 0; j_2__ < KX_j_2_max__; ++j_2__) {
                    for (size_t j_1__ = 0; j_1__ < KX_j_1_max__; ++j_1__) {
                        for (size_t k_0__ = 0; k_0__ < KX_k_0_max__; ++k_0__) {
                            vars__.push_back(KX[k_0__](j_1__, j_2__));
                        }
                    }
                }
                size_t F_j_1_max__ = n;
        ...
        if (include_tparams__) {
            ...
            for (size_t j_2__ = 0; j_2__ < KX_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < KX_j_1_max__; ++j_1__) {
                    for (size_t k_0__ = 0; k_0__ < KX_k_0_max__; ++k_0__) {
                        param_name_stream__.str(std::string());
                        param_name_stream__ << "KX" << '.' << k_0__ + 1 << '.' << j_1__ + 1 << '.' << j_2__ + 1;
                        param_names__.push_back(param_name_stream__.str());
                    }
                }
            }
