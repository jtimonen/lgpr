...
namespace model_fp_latent_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_fp_latent");
    ...
    reader.add_event(15, 1, "restart", "model_fp_latent");
    ...
    reader.add_event(261, 4, "restart", "model_fp_latent");
    ...
    reader.add_event(280, 5, "restart", "model_fp_latent");
    ...
    reader.add_event(334, 9, "restart", "model_fp_latent");
    ...
    reader.add_event(340, 10, "restart", "model_fp_latent");
    ...
    reader.add_event(347, 11, "restart", "model_fp_latent");
    ...
    reader.add_event(354, 12, "restart", "model_fp_latent");
    ...
    reader.add_event(370, 21, "restart", "model_fp_latent");
    ...
    reader.add_event(381, 22, "restart", "model_fp_latent");
    reader.add_event(413, 52, "end", "model_fp_latent");
    return reader;
}
...
class model_fp_latent
  : public stan::model::model_base_crtp<model_fp_latent> {
private:
        int is_verbose;
...
public:
    model_fp_latent(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_fp_latent_namespace::model_fp_latent";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_fp_latent_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            validate_non_negative_index("f_draws", "num_pred", num_pred);
            validate_non_negative_index("f_draws", "S", S);
            validate_non_negative_index("f_draws", "num_comps", num_comps);
            std::vector<std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > > f_draws(S, std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >(num_comps, Eigen::Matrix<double, Eigen::Dynamic, 1>(num_pred)));
            stan::math::initialize(f_draws, DUMMY_VAR__);
            stan::math::fill(f_draws, DUMMY_VAR__);
            ...
            for (int is = 1; is <= S; ++is) {
                ...
                stan::model::assign(f_draws, 
                            ...
                            "assigning variable f_draws");
                }
            }
            // validate, write generated quantities
            current_statement_begin__ = 385;
            size_t f_draws_j_1_max__ = num_pred;
            size_t f_draws_k_0_max__ = S;
            size_t f_draws_k_1_max__ = num_comps;
            for (size_t j_1__ = 0; j_1__ < f_draws_j_1_max__; ++j_1__) {
                for (size_t k_1__ = 0; k_1__ < f_draws_k_1_max__; ++k_1__) {
                    for (size_t k_0__ = 0; k_0__ < f_draws_k_0_max__; ++k_0__) {
                        vars__.push_back(f_draws[k_0__][k_1__](j_1__));
                    }
                }
            }
        } catch (const std::exception& e) {
        ...
        for (size_t j_1__ = 0; j_1__ < f_draws_j_1_max__; ++j_1__) {
            for (size_t k_1__ = 0; k_1__ < f_draws_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < f_draws_k_0_max__; ++k_0__) {
                    ...
                    param_name_stream__ << "f_draws" << '.' << k_0__ + 1 << '.' << k_1__ + 1 << '.' << j_1__ + 1;
...
typedef model_fp_latent_namespace::model_fp_latent stan_model;
#ifndef USING_R
