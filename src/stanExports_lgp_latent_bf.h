...
namespace model_lgp_latent_bf_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lgp_latent_bf");
    ...
    reader.add_event(15, 1, "restart", "model_lgp_latent_bf");
    ...
    reader.add_event(68, 4, "restart", "model_lgp_latent_bf");
    ...
    reader.add_event(94, 5, "restart", "model_lgp_latent_bf");
    ...
    reader.add_event(336, 6, "restart", "model_lgp_latent_bf");
    ...
    reader.add_event(460, 7, "restart", "model_lgp_latent_bf");
    ...
    reader.add_event(501, 11, "restart", "model_lgp_latent_bf");
    ...
    reader.add_event(516, 12, "restart", "model_lgp_latent_bf");
    ...
    reader.add_event(526, 13, "restart", "model_lgp_latent_bf");
    ...
    reader.add_event(532, 14, "restart", "model_lgp_latent_bf");
    ...
    reader.add_event(536, 15, "restart", "model_lgp_latent_bf");
    ...
    reader.add_event(559, 34, "restart", "model_lgp_latent_bf");
    ...
    reader.add_event(562, 35, "restart", "model_lgp_latent_bf");
    ...
    reader.add_event(572, 41, "restart", "model_lgp_latent_bf");
    ...
    reader.add_event(606, 46, "restart", "model_lgp_latent_bf");
    ...
    reader.add_event(614, 47, "restart", "model_lgp_latent_bf");
    reader.add_event(614, 47, "include", "_latent/likelihood.stan");
    reader.add_event(614, 0, "start", "_latent/likelihood.stan");
    reader.add_event(639, 25, "end", "_latent/likelihood.stan");
    reader.add_event(639, 48, "restart", "model_lgp_latent_bf");
    reader.add_event(642, 49, "end", "model_lgp_latent_bf");
    return reader;
}
...
class model_lgp_latent_bf
  : public stan::model::model_base_crtp<model_lgp_latent_bf> {
private:
        int is_verbose;
        ...
        int num_xi;
public:
    model_lgp_latent_bf(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lgp_latent_bf_namespace::model_lgp_latent_bf";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lgp_latent_bf_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_lgp_latent_bf_namespace::model_lgp_latent_bf stan_model;
#ifndef USING_R
