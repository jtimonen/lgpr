...
#include "stanExports_predict_marginal.h"

RCPP_MODULE(stan_fit4predict_marginal_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_predict_marginal")
