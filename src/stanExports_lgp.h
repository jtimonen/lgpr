...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(170, 66, "end", "chunks/functions-posterior.stan");
    reader.add_event(170, 22, "restart", "model_lgp");
    reader.add_event(170, 22, "include", "chunks/functions-kernels_const.stan");
    reader.add_event(170, 0, "start", "chunks/functions-kernels_const.stan");
    reader.add_event(291, 121, "end", "chunks/functions-kernels_const.stan");
    reader.add_event(291, 23, "restart", "model_lgp");
    reader.add_event(291, 23, "include", "chunks/functions-kernels.stan");
    reader.add_event(291, 0, "start", "chunks/functions-kernels.stan");
    reader.add_event(414, 123, "end", "chunks/functions-kernels.stan");
    reader.add_event(414, 24, "restart", "model_lgp");
    reader.add_event(417, 27, "include", "chunks/data.stan");
    reader.add_event(417, 0, "start", "chunks/data.stan");
    reader.add_event(536, 119, "end", "chunks/data.stan");
    reader.add_event(536, 28, "restart", "model_lgp");
    reader.add_event(539, 31, "include", "chunks/data-transformed.stan");
    reader.add_event(539, 0, "start", "chunks/data-transformed.stan");
    reader.add_event(546, 7, "end", "chunks/data-transformed.stan");
    reader.add_event(546, 32, "restart", "model_lgp");
    reader.add_event(549, 35, "include", "chunks/parameters.stan");
    reader.add_event(549, 0, "start", "chunks/parameters.stan");
    reader.add_event(563, 14, "end", "chunks/parameters.stan");
    reader.add_event(563, 36, "restart", "model_lgp");
    reader.add_event(566, 39, "include", "chunks/parameters-transformed.stan");
    reader.add_event(566, 0, "start", "chunks/parameters-transformed.stan");
    reader.add_event(589, 23, "end", "chunks/parameters-transformed.stan");
    reader.add_event(589, 40, "restart", "model_lgp");
    reader.add_event(592, 43, "include", "chunks/model-prior.stan");
    reader.add_event(592, 0, "start", "chunks/model-prior.stan");
    reader.add_event(638, 46, "end", "chunks/model-prior.stan");
    reader.add_event(638, 44, "restart", "model_lgp");
    reader.add_event(640, 46, "include", "chunks/model-likelihood.stan");
    reader.add_event(640, 0, "start", "chunks/model-likelihood.stan");
    reader.add_event(691, 51, "end", "chunks/model-likelihood.stan");
    reader.add_event(691, 47, "restart", "model_lgp");
    reader.add_event(695, 51, "include", "chunks/generated.stan");
    reader.add_event(695, 0, "start", "chunks/generated.stan");
    reader.add_event(747, 52, "end", "chunks/generated.stan");
    reader.add_event(747, 52, "restart", "model_lgp");
    reader.add_event(750, 53, "end", "model_lgp");
    return reader;
}
