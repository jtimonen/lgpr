...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(326, 76, "end", "chunks/data.stan");
    reader.add_event(326, 29, "restart", "model_lgp");
    reader.add_event(330, 33, "include", "chunks/transformed_data.stan");
    reader.add_event(330, 0, "start", "chunks/transformed_data.stan");
    reader.add_event(357, 27, "end", "chunks/transformed_data.stan");
    reader.add_event(357, 34, "restart", "model_lgp");
    reader.add_event(361, 38, "include", "chunks/parameters.stan");
    reader.add_event(361, 0, "start", "chunks/parameters.stan");
    reader.add_event(386, 25, "end", "chunks/parameters.stan");
    reader.add_event(386, 39, "restart", "model_lgp");
    reader.add_event(390, 43, "include", "chunks/transformed_parameters.stan");
    reader.add_event(390, 0, "start", "chunks/transformed_parameters.stan");
    reader.add_event(404, 14, "end", "chunks/transformed_parameters.stan");
    reader.add_event(404, 44, "restart", "model_lgp");
    reader.add_event(408, 48, "include", "chunks/model_priors.stan");
    reader.add_event(408, 0, "start", "chunks/model_priors.stan");
    reader.add_event(481, 73, "end", "chunks/model_priors.stan");
    reader.add_event(481, 49, "restart", "model_lgp");
    reader.add_event(482, 50, "include", "chunks/model_likelihood.stan");
    reader.add_event(482, 0, "start", "chunks/model_likelihood.stan");
    reader.add_event(530, 48, "end", "chunks/model_likelihood.stan");
    reader.add_event(530, 51, "restart", "model_lgp");
    reader.add_event(535, 56, "include", "chunks/generated_quantities.stan");
    reader.add_event(535, 0, "start", "chunks/generated_quantities.stan");
    reader.add_event(564, 29, "end", "chunks/generated_quantities.stan");
    reader.add_event(564, 57, "restart", "model_lgp");
    reader.add_event(567, 58, "end", "model_lgp");
    return reader;
}
