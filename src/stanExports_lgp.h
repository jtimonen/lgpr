...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(140, 119, "end", "chunks/functions_kernels_base.stan");
    reader.add_event(140, 22, "restart", "model_lgp");
    reader.add_event(140, 22, "include", "chunks/functions_kernels.stan");
    reader.add_event(140, 0, "start", "chunks/functions_kernels.stan");
    reader.add_event(228, 88, "end", "chunks/functions_kernels.stan");
    reader.add_event(228, 23, "restart", "model_lgp");
    reader.add_event(228, 23, "include", "chunks/functions_log_prior.stan");
    reader.add_event(228, 0, "start", "chunks/functions_log_prior.stan");
    reader.add_event(266, 38, "end", "chunks/functions_log_prior.stan");
    reader.add_event(266, 24, "restart", "model_lgp");
    reader.add_event(270, 28, "include", "chunks/data.stan");
    reader.add_event(270, 0, "start", "chunks/data.stan");
    reader.add_event(346, 76, "end", "chunks/data.stan");
    reader.add_event(346, 29, "restart", "model_lgp");
    reader.add_event(350, 33, "include", "chunks/transformed_data.stan");
    reader.add_event(350, 0, "start", "chunks/transformed_data.stan");
    reader.add_event(377, 27, "end", "chunks/transformed_data.stan");
    reader.add_event(377, 34, "restart", "model_lgp");
    reader.add_event(381, 38, "include", "chunks/parameters.stan");
    reader.add_event(381, 0, "start", "chunks/parameters.stan");
    reader.add_event(406, 25, "end", "chunks/parameters.stan");
    reader.add_event(406, 39, "restart", "model_lgp");
    reader.add_event(410, 43, "include", "chunks/transformed_parameters.stan");
    reader.add_event(410, 0, "start", "chunks/transformed_parameters.stan");
    reader.add_event(424, 14, "end", "chunks/transformed_parameters.stan");
    reader.add_event(424, 44, "restart", "model_lgp");
    reader.add_event(428, 48, "include", "chunks/model_priors.stan");
    reader.add_event(428, 0, "start", "chunks/model_priors.stan");
    reader.add_event(501, 73, "end", "chunks/model_priors.stan");
    reader.add_event(501, 49, "restart", "model_lgp");
    reader.add_event(502, 50, "include", "chunks/model_likelihood.stan");
    reader.add_event(502, 0, "start", "chunks/model_likelihood.stan");
    reader.add_event(550, 48, "end", "chunks/model_likelihood.stan");
    reader.add_event(550, 51, "restart", "model_lgp");
    reader.add_event(555, 56, "include", "chunks/generated_quantities.stan");
    reader.add_event(555, 0, "start", "chunks/generated_quantities.stan");
    reader.add_event(584, 29, "end", "chunks/generated_quantities.stan");
    reader.add_event(584, 57, "restart", "model_lgp");
    reader.add_event(587, 58, "end", "model_lgp");
    return reader;
}
...
STAN_phi(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& x,
    ...
    try {
        ...
        stan::math::assign(A,(1 / stan::math::sqrt(L)));
        current_statement_begin__ = 36;
        local_scalar_t__ B(DUMMY_VAR__);
        (void) B;  // dummy to suppress unused var warning
        stan::math::initialize(B, DUMMY_VAR__);
        stan::math::fill(B, DUMMY_VAR__);
        stan::math::assign(B,((stan::math::pi() * m) / (2 * L)));
...
STAN_lambda(const int& m,
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(pow(A, 2));
        }
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
...
STAN_spd_eq(const T0__& w,
    ...
    try {
        ...
        stan::math::initialize(A, DUMMY_VAR__);
        stan::math::fill(A, DUMMY_VAR__);
        stan::math::assign(A,((pow(alpha, 2) * ell) * stan::math::sqrt((2 * stan::math::pi()))));
