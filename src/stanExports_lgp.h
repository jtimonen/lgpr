...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(568, 119, "end", "chunks/data.stan");
    reader.add_event(568, 29, "restart", "model_lgp");
    reader.add_event(571, 32, "include", "chunks/data-transformed.stan");
    reader.add_event(571, 0, "start", "chunks/data-transformed.stan");
    reader.add_event(578, 7, "end", "chunks/data-transformed.stan");
    reader.add_event(578, 33, "restart", "model_lgp");
    reader.add_event(581, 36, "include", "chunks/parameters.stan");
    reader.add_event(581, 0, "start", "chunks/parameters.stan");
    reader.add_event(595, 14, "end", "chunks/parameters.stan");
    reader.add_event(595, 37, "restart", "model_lgp");
    reader.add_event(598, 40, "include", "chunks/parameters-transformed.stan");
    reader.add_event(598, 0, "start", "chunks/parameters-transformed.stan");
    reader.add_event(621, 23, "end", "chunks/parameters-transformed.stan");
    reader.add_event(621, 41, "restart", "model_lgp");
    reader.add_event(624, 44, "include", "chunks/model-prior.stan");
    reader.add_event(624, 0, "start", "chunks/model-prior.stan");
    reader.add_event(670, 46, "end", "chunks/model-prior.stan");
    reader.add_event(670, 45, "restart", "model_lgp");
    reader.add_event(672, 47, "include", "chunks/model-likelihood.stan");
    reader.add_event(672, 0, "start", "chunks/model-likelihood.stan");
    reader.add_event(720, 48, "end", "chunks/model-likelihood.stan");
    reader.add_event(720, 48, "restart", "model_lgp");
    reader.add_event(724, 52, "include", "chunks/generated.stan");
    reader.add_event(724, 0, "start", "chunks/generated.stan");
    reader.add_event(776, 52, "end", "chunks/generated.stan");
    reader.add_event(776, 53, "restart", "model_lgp");
    reader.add_event(779, 54, "end", "model_lgp");
    return reader;
}
...
STAN_bfa_lambda(const int& m,
    ...
    try {
        ...
        stan::math::initialize(A, DUMMY_VAR__);
        stan::math::fill(A, DUMMY_VAR__);
        stan::math::assign(A,((stan::math::pi() * m) / (2 * L)));
...
STAN_spd_eq(const T0__& w,
    ...
    try {
        ...
        stan::math::initialize(A, DUMMY_VAR__);
        stan::math::fill(A, DUMMY_VAR__);
        stan::math::assign(A,((square(alpha) * ell) * stan::math::sqrt((2 * stan::math::pi()))));
        current_statement_begin__ = 413;
        local_scalar_t__ B(DUMMY_VAR__);
        (void) B;  // dummy to suppress unused var warning
        stan::math::initialize(B, DUMMY_VAR__);
        stan::math::fill(B, DUMMY_VAR__);
        stan::math::assign(B,(2 * square((stan::math::pi() * ell))));
...
STAN_multi_normal_bfa_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& y,
    ...
    try {
        ...
        stan::math::assign(t1,(n * stan::math::log((2 * stan::math::pi()))));
