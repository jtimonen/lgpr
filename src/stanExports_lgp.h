...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(130, 109, "end", "chunks/functions_kernels_base.stan");
    reader.add_event(130, 22, "restart", "model_lgp");
    reader.add_event(130, 22, "include", "chunks/functions_kernels.stan");
    reader.add_event(130, 0, "start", "chunks/functions_kernels.stan");
    reader.add_event(218, 88, "end", "chunks/functions_kernels.stan");
    reader.add_event(218, 23, "restart", "model_lgp");
    reader.add_event(218, 23, "include", "chunks/functions_log_prior.stan");
    reader.add_event(218, 0, "start", "chunks/functions_log_prior.stan");
    reader.add_event(256, 38, "end", "chunks/functions_log_prior.stan");
    reader.add_event(256, 24, "restart", "model_lgp");
    reader.add_event(260, 28, "include", "chunks/data.stan");
    reader.add_event(260, 0, "start", "chunks/data.stan");
    reader.add_event(330, 70, "end", "chunks/data.stan");
    reader.add_event(330, 29, "restart", "model_lgp");
    reader.add_event(334, 33, "include", "chunks/transformed_data.stan");
    reader.add_event(334, 0, "start", "chunks/transformed_data.stan");
    reader.add_event(364, 30, "end", "chunks/transformed_data.stan");
    reader.add_event(364, 34, "restart", "model_lgp");
    reader.add_event(368, 38, "include", "chunks/parameters.stan");
    reader.add_event(368, 0, "start", "chunks/parameters.stan");
    reader.add_event(393, 25, "end", "chunks/parameters.stan");
    reader.add_event(393, 39, "restart", "model_lgp");
    reader.add_event(397, 43, "include", "chunks/transformed_parameters.stan");
    reader.add_event(397, 0, "start", "chunks/transformed_parameters.stan");
    reader.add_event(411, 14, "end", "chunks/transformed_parameters.stan");
    reader.add_event(411, 44, "restart", "model_lgp");
    reader.add_event(415, 48, "include", "chunks/model_priors.stan");
    reader.add_event(415, 0, "start", "chunks/model_priors.stan");
    reader.add_event(488, 73, "end", "chunks/model_priors.stan");
    reader.add_event(488, 49, "restart", "model_lgp");
    reader.add_event(489, 50, "include", "chunks/model_likelihood.stan");
    reader.add_event(489, 0, "start", "chunks/model_likelihood.stan");
    reader.add_event(536, 47, "end", "chunks/model_likelihood.stan");
    reader.add_event(536, 51, "restart", "model_lgp");
    reader.add_event(541, 56, "include", "chunks/generated_quantities.stan");
    reader.add_event(541, 0, "start", "chunks/generated_quantities.stan");
    reader.add_event(570, 29, "end", "chunks/generated_quantities.stan");
    reader.add_event(570, 57, "restart", "model_lgp");
    reader.add_event(573, 58, "end", "model_lgp");
    return reader;
}
