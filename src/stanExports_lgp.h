...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(331, 71, "end", "chunks/data.stan");
    reader.add_event(331, 29, "restart", "model_lgp");
    reader.add_event(335, 33, "include", "chunks/transformed_data.stan");
    reader.add_event(335, 0, "start", "chunks/transformed_data.stan");
    reader.add_event(366, 31, "end", "chunks/transformed_data.stan");
    reader.add_event(366, 34, "restart", "model_lgp");
    reader.add_event(370, 38, "include", "chunks/parameters.stan");
    reader.add_event(370, 0, "start", "chunks/parameters.stan");
    reader.add_event(395, 25, "end", "chunks/parameters.stan");
    reader.add_event(395, 39, "restart", "model_lgp");
    reader.add_event(399, 43, "include", "chunks/transformed_parameters.stan");
    reader.add_event(399, 0, "start", "chunks/transformed_parameters.stan");
    reader.add_event(413, 14, "end", "chunks/transformed_parameters.stan");
    reader.add_event(413, 44, "restart", "model_lgp");
    reader.add_event(417, 48, "include", "chunks/model_priors.stan");
    reader.add_event(417, 0, "start", "chunks/model_priors.stan");
    reader.add_event(490, 73, "end", "chunks/model_priors.stan");
    reader.add_event(490, 49, "restart", "model_lgp");
    reader.add_event(491, 50, "include", "chunks/model_likelihood.stan");
    reader.add_event(491, 0, "start", "chunks/model_likelihood.stan");
    reader.add_event(538, 47, "end", "chunks/model_likelihood.stan");
    reader.add_event(538, 51, "restart", "model_lgp");
    reader.add_event(543, 56, "include", "chunks/generated_quantities.stan");
    reader.add_event(543, 0, "start", "chunks/generated_quantities.stan");
    reader.add_event(572, 29, "end", "chunks/generated_quantities.stan");
    reader.add_event(572, 57, "restart", "model_lgp");
    reader.add_event(575, 58, "end", "model_lgp");
    return reader;
}
