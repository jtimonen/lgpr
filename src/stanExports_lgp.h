...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(383, 26, "end", "chunks/parameters.stan");
    reader.add_event(383, 39, "restart", "model_lgp");
    reader.add_event(387, 43, "include", "chunks/transformed_parameters.stan");
    reader.add_event(387, 0, "start", "chunks/transformed_parameters.stan");
    reader.add_event(401, 14, "end", "chunks/transformed_parameters.stan");
    reader.add_event(401, 44, "restart", "model_lgp");
    reader.add_event(405, 48, "include", "chunks/model_priors.stan");
    reader.add_event(405, 0, "start", "chunks/model_priors.stan");
    reader.add_event(478, 73, "end", "chunks/model_priors.stan");
    reader.add_event(478, 49, "restart", "model_lgp");
    reader.add_event(479, 50, "include", "chunks/model_likelihood.stan");
    reader.add_event(479, 0, "start", "chunks/model_likelihood.stan");
    reader.add_event(531, 52, "end", "chunks/model_likelihood.stan");
    reader.add_event(531, 51, "restart", "model_lgp");
    reader.add_event(536, 56, "include", "chunks/generated_quantities.stan");
    reader.add_event(536, 0, "start", "chunks/generated_quantities.stan");
    reader.add_event(565, 29, "end", "chunks/generated_quantities.stan");
    reader.add_event(565, 57, "restart", "model_lgp");
    reader.add_event(568, 58, "end", "model_lgp");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            check_less_or_equal(function__, "LH", LH, 5);
            ...
            context__.validate_dims("data initialization", "N_ordinal", "int", context__.to_vec());
            N_ordinal = int(0);
            vals_i__ = context__.vals_i("N_ordinal");
            pos__ = 0;
            N_ordinal = vals_i__[pos__++];
            check_greater_or_equal(function__, "N_ordinal", N_ordinal, 1);
            ...
            validate_non_negative_index("cut_points", "(N_ordinal - 1)", (N_ordinal - 1));
            validate_non_negative_index("cut_points", "logical_eq(LH, 5)", logical_eq(LH, 5));
            num_params_r__ += ((N_ordinal - 1) * logical_eq(LH, 5));
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 379;
        if (!(context__.contains_r("cut_points")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable cut_points missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("cut_points");
        pos__ = 0U;
        validate_non_negative_index("cut_points", "(N_ordinal - 1)", (N_ordinal - 1));
        validate_non_negative_index("cut_points", "logical_eq(LH, 5)", logical_eq(LH, 5));
        context__.validate_dims("parameter initialization", "cut_points", "vector_d", context__.to_vec(logical_eq(LH, 5),(N_ordinal - 1)));
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > cut_points(logical_eq(LH, 5), Eigen::Matrix<double, Eigen::Dynamic, 1>((N_ordinal - 1)));
        size_t cut_points_j_1_max__ = (N_ordinal - 1);
        size_t cut_points_k_0_max__ = logical_eq(LH, 5);
        for (size_t j_1__ = 0; j_1__ < cut_points_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < cut_points_k_0_max__; ++k_0__) {
                cut_points[k_0__](j_1__) = vals_r__[pos__++];
            }
        }
        size_t cut_points_i_0_max__ = logical_eq(LH, 5);
        for (size_t i_0__ = 0; i_0__ < cut_points_i_0_max__; ++i_0__) {
            try {
                writer__.ordered_unconstrain(cut_points[i_0__]);
            } catch (const std::exception& e) {
                stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable cut_points: ") + e.what()), current_statement_begin__, prog_reader__());
            }
        }
        current_statement_begin__ = 382;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 379;
            std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > cut_points;
            size_t cut_points_d_0_max__ = logical_eq(LH, 5);
            cut_points.reserve(cut_points_d_0_max__);
            for (size_t d_0__ = 0; d_0__ < cut_points_d_0_max__; ++d_0__) {
                if (jacobian__)
                    cut_points.push_back(in__.ordered_constrain((N_ordinal - 1), lp__));
                else
                    cut_points.push_back(in__.ordered_constrain((N_ordinal - 1)));
            }
            current_statement_begin__ = 382;
            ...
            if (as_bool(logical_neq(LH, 0))) {
                ...
                if (as_bool(F_IS_SAMPLED)) {
                    ...
                    } else if (as_bool(logical_eq(LH, 5))) {
                        {
                        current_statement_begin__ = 510;
                        validate_non_negative_index("ETA_P", "n", n);
                        Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> ETA_P(n);
                        stan::math::initialize(ETA_P, DUMMY_VAR__);
                        stan::math::fill(ETA_P, DUMMY_VAR__);
                        stan::math::assign(ETA_P,F_ss);
                        current_statement_begin__ = 511;
                        lp_accum__.add(ordered_probit_log<propto__>(y_int, ETA_P, get_base1(cut_points, 1, "cut_points", 1)));
                        }
                    } else {
                    ...
                    lp_accum__.add(multi_normal_cholesky_log<propto__>(y, C_hat, Ly));
                    }
                }
            }
        } catch (const std::exception& e) {
    ...
    void get_dims(std::vector<std::vector<size_t> >& dimss__) const {
        ...
        dimss__.push_back(dims__);
        dims__.resize(0);
        dims__.push_back(logical_eq(LH, 5));
        dims__.push_back((N_ordinal - 1));
        dimss__.push_back(dims__);
        dims__.resize(0);
    ...
    void write_array(RNG& base_rng__,
        ...
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > cut_points;
        size_t cut_points_d_0_max__ = logical_eq(LH, 5);
        cut_points.reserve(cut_points_d_0_max__);
        for (size_t d_0__ = 0; d_0__ < cut_points_d_0_max__; ++d_0__) {
            cut_points.push_back(in__.ordered_constrain((N_ordinal - 1)));
        ...
        for (size_t j_1__ = 0; j_1__ < cut_points_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < cut_points_k_0_max__; ++k_0__) {
                vars__.push_back(cut_points[k_0__](j_1__));
            }
        }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < cut_points_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < cut_points_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "cut_points" << '.' << k_0__ + 1 << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        size_t beta_j_1_max__ = N_cases;
