...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(50, 31, "end", "chunks/functions-utils.stan");
    reader.add_event(50, 20, "restart", "model_lgp");
    reader.add_event(50, 20, "include", "chunks/functions-prior.stan");
    reader.add_event(50, 0, "start", "chunks/functions-prior.stan");
    reader.add_event(92, 42, "end", "chunks/functions-prior.stan");
    reader.add_event(92, 21, "restart", "model_lgp");
    reader.add_event(92, 21, "include", "chunks/functions-posterior.stan");
    reader.add_event(92, 0, "start", "chunks/functions-posterior.stan");
    reader.add_event(145, 53, "end", "chunks/functions-posterior.stan");
    reader.add_event(145, 22, "restart", "model_lgp");
    reader.add_event(145, 22, "include", "chunks/functions-kernels_base.stan");
    reader.add_event(145, 0, "start", "chunks/functions-kernels_base.stan");
    reader.add_event(234, 89, "end", "chunks/functions-kernels_base.stan");
    reader.add_event(234, 23, "restart", "model_lgp");
    reader.add_event(234, 23, "include", "chunks/functions-kernels_single.stan");
    reader.add_event(234, 0, "start", "chunks/functions-kernels_single.stan");
    reader.add_event(385, 151, "end", "chunks/functions-kernels_single.stan");
    reader.add_event(385, 24, "restart", "model_lgp");
    reader.add_event(385, 24, "include", "chunks/functions-kernels_many.stan");
    reader.add_event(385, 0, "start", "chunks/functions-kernels_many.stan");
    reader.add_event(472, 87, "end", "chunks/functions-kernels_many.stan");
    reader.add_event(472, 25, "restart", "model_lgp");
    reader.add_event(475, 28, "include", "chunks/data.stan");
    reader.add_event(475, 0, "start", "chunks/data.stan");
    reader.add_event(592, 117, "end", "chunks/data.stan");
    reader.add_event(592, 29, "restart", "model_lgp");
    reader.add_event(595, 32, "include", "chunks/data-transformed.stan");
    reader.add_event(595, 0, "start", "chunks/data-transformed.stan");
    reader.add_event(605, 10, "end", "chunks/data-transformed.stan");
    reader.add_event(605, 33, "restart", "model_lgp");
    reader.add_event(608, 36, "include", "chunks/parameters.stan");
    reader.add_event(608, 0, "start", "chunks/parameters.stan");
    reader.add_event(623, 15, "end", "chunks/parameters.stan");
    reader.add_event(623, 37, "restart", "model_lgp");
    reader.add_event(626, 40, "include", "chunks/parameters-transformed.stan");
    reader.add_event(626, 0, "start", "chunks/parameters-transformed.stan");
    reader.add_event(648, 22, "end", "chunks/parameters-transformed.stan");
    reader.add_event(648, 41, "restart", "model_lgp");
    reader.add_event(651, 44, "include", "chunks/model-prior.stan");
    reader.add_event(651, 0, "start", "chunks/model-prior.stan");
    reader.add_event(707, 56, "end", "chunks/model-prior.stan");
    reader.add_event(707, 45, "restart", "model_lgp");
    reader.add_event(709, 47, "include", "chunks/model-likelihood.stan");
    reader.add_event(709, 0, "start", "chunks/model-likelihood.stan");
    reader.add_event(757, 48, "end", "chunks/model-likelihood.stan");
    reader.add_event(757, 48, "restart", "model_lgp");
    reader.add_event(761, 52, "include", "chunks/generated.stan");
    reader.add_event(761, 0, "start", "chunks/generated.stan");
    reader.add_event(780, 19, "end", "chunks/generated.stan");
    reader.add_event(780, 53, "restart", "model_lgp");
    reader.add_event(783, 54, "end", "model_lgp");
    return reader;
}
