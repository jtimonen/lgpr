...
namespace model_predict_latent_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_predict_latent");
    ...
    reader.add_event(15, 1, "restart", "model_predict_latent");
    ...
    reader.add_event(261, 4, "restart", "model_predict_latent");
    reader.add_event(261, 4, "include", "_common/functions-kr.stan");
    reader.add_event(261, 0, "start", "_common/functions-kr.stan");
    reader.add_event(280, 19, "end", "_common/functions-kr.stan");
    reader.add_event(280, 5, "restart", "model_predict_latent");
    reader.add_event(283, 8, "include", "_common/data-general.stan");
    reader.add_event(283, 0, "start", "_common/data-general.stan");
    reader.add_event(334, 51, "end", "_common/data-general.stan");
    reader.add_event(334, 9, "restart", "model_predict_latent");
    reader.add_event(334, 9, "include", "_common/data-covariates.stan");
    reader.add_event(334, 0, "start", "_common/data-covariates.stan");
    reader.add_event(340, 6, "end", "_common/data-covariates.stan");
    reader.add_event(340, 10, "restart", "model_predict_latent");
    reader.add_event(340, 10, "include", "_common/data-pred.stan");
    reader.add_event(340, 0, "start", "_common/data-pred.stan");
    reader.add_event(347, 7, "end", "_common/data-pred.stan");
    reader.add_event(347, 11, "restart", "model_predict_latent");
    reader.add_event(347, 11, "include", "_common/data-draws.stan");
    reader.add_event(347, 0, "start", "_common/data-draws.stan");
    reader.add_event(354, 7, "end", "_common/data-draws.stan");
    reader.add_event(354, 12, "restart", "model_predict_latent");
    reader.add_event(362, 20, "include", "_common/tdata.stan");
    reader.add_event(362, 0, "start", "_common/tdata.stan");
    reader.add_event(370, 8, "end", "_common/tdata.stan");
    reader.add_event(370, 21, "restart", "model_predict_latent");
    reader.add_event(370, 21, "include", "_common/tdata-pred.stan");
    reader.add_event(370, 0, "start", "_common/tdata-pred.stan");
    reader.add_event(381, 11, "end", "_common/tdata-pred.stan");
    reader.add_event(381, 22, "restart", "model_predict_latent");
    reader.add_event(413, 52, "end", "model_predict_latent");
    return reader;
}
...
STAN_kr(const std::vector<Eigen::Matrix<T0__, Eigen::Dynamic, 1> >& f_latent,
            const std::vector<Eigen::Matrix<T1__, Eigen::Dynamic, Eigen::Dynamic> >& KX,
            const std::vector<Eigen::Matrix<T2__, Eigen::Dynamic, Eigen::Dynamic> >& KX_s,
            const std::vector<Eigen::Matrix<T3__, Eigen::Dynamic, Eigen::Dynamic> >& KX_ss,
    ...
    try {
        ...
        validate_non_negative_index("F_KR", "p", p);
        validate_non_negative_index("F_KR", "J", J);
        std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1>  > F_KR(J, Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1>(p));
        stan::math::initialize(F_KR, DUMMY_VAR__);
        stan::math::fill(F_KR, DUMMY_VAR__);
        current_statement_begin__ = 278;
        return stan::math::promote_scalar<fun_return_scalar_t__>(F_KR);
        }
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
...
struct STAN_kr_functor__ {
    template <typename T0__, typename T1__, typename T2__, typename T3__, typename T4__>
        std::vector<Eigen::Matrix<typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__>::type>::type, Eigen::Dynamic, 1> >
    operator()(const std::vector<Eigen::Matrix<T0__, Eigen::Dynamic, 1> >& f_latent,
            const std::vector<Eigen::Matrix<T1__, Eigen::Dynamic, Eigen::Dynamic> >& KX,
            const std::vector<Eigen::Matrix<T2__, Eigen::Dynamic, Eigen::Dynamic> >& KX_s,
            const std::vector<Eigen::Matrix<T3__, Eigen::Dynamic, Eigen::Dynamic> >& KX_ss,
            const T4__& delta, std::ostream* pstream__) const {
        return STAN_kr(f_latent, KX, KX_s, KX_ss, delta, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_predict_latent
  : public stan::model::model_base_crtp<model_predict_latent> {
private:
        int is_verbose;
        ...
        int obs_model;
        std::vector<std::vector<vector_d> > d_f_latent;
...
public:
    model_predict_latent(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_predict_latent_namespace::model_predict_latent";
        ...
        try {
            ...
            validate_non_negative_index("d_f_latent", "num_pred", num_pred);
            validate_non_negative_index("d_f_latent", "S", S);
            validate_non_negative_index("d_f_latent", "num_comps", num_comps);
            context__.validate_dims("data initialization", "d_f_latent", "vector_d", context__.to_vec(S,num_comps,num_pred));
            d_f_latent = std::vector<std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > >(S, std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >(num_comps, Eigen::Matrix<double, Eigen::Dynamic, 1>(num_pred)));
            vals_r__ = context__.vals_r("d_f_latent");
            pos__ = 0;
            size_t d_f_latent_j_1_max__ = num_pred;
            size_t d_f_latent_k_0_max__ = S;
            size_t d_f_latent_k_1_max__ = num_comps;
            for (size_t j_1__ = 0; j_1__ < d_f_latent_j_1_max__; ++j_1__) {
                for (size_t k_1__ = 0; k_1__ < d_f_latent_k_1_max__; ++k_1__) {
                    for (size_t k_0__ = 0; k_0__ < d_f_latent_k_0_max__; ++k_0__) {
                        d_f_latent[k_0__][k_1__](j_1__) = vals_r__[pos__++];
                    }
                }
            }
            size_t d_f_latent_i_0_max__ = S;
            size_t d_f_latent_i_1_max__ = num_comps;
            for (size_t i_0__ = 0; i_0__ < d_f_latent_i_0_max__; ++i_0__) {
                for (size_t i_1__ = 0; i_1__ < d_f_latent_i_1_max__; ++i_1__) {
                    check_greater_or_equal(function__, "d_f_latent[i_0__][i_1__]", d_f_latent[i_0__][i_1__], 0);
                }
            }
            current_statement_begin__ = 357;
            validate_non_negative_index("d_sigma", "S", S);
            validate_non_negative_index("d_sigma", "logical_eq(obs_model, 1)", logical_eq(obs_model, 1));
            context__.validate_dims("data initialization", "d_sigma", "double", context__.to_vec(S,logical_eq(obs_model, 1)));
            d_sigma = std::vector<std::vector<double> >(S, std::vector<double>(logical_eq(obs_model, 1), double(0)));
            vals_r__ = context__.vals_r("d_sigma");
            pos__ = 0;
            size_t d_sigma_k_0_max__ = S;
            size_t d_sigma_k_1_max__ = logical_eq(obs_model, 1);
            ...
            size_t d_sigma_i_1_max__ = logical_eq(obs_model, 1);
            ...
            validate_non_negative_index("d_phi", "S", S);
            validate_non_negative_index("d_phi", "logical_eq(obs_model, 1)", logical_eq(obs_model, 1));
            context__.validate_dims("data initialization", "d_phi", "double", context__.to_vec(S,logical_eq(obs_model, 1)));
            d_phi = std::vector<std::vector<double> >(S, std::vector<double>(logical_eq(obs_model, 1), double(0)));
            vals_r__ = context__.vals_r("d_phi");
            pos__ = 0;
            size_t d_phi_k_0_max__ = S;
            size_t d_phi_k_1_max__ = logical_eq(obs_model, 1);
            for (size_t k_1__ = 0; k_1__ < d_phi_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < d_phi_k_0_max__; ++k_0__) {
                    d_phi[k_0__][k_1__] = vals_r__[pos__++];
                }
            }
            size_t d_phi_i_0_max__ = S;
            size_t d_phi_i_1_max__ = logical_eq(obs_model, 1);
            for (size_t i_0__ = 0; i_0__ < d_phi_i_0_max__; ++i_0__) {
                for (size_t i_1__ = 0; i_1__ < d_phi_i_1_max__; ++i_1__) {
                    check_greater_or_equal(function__, "d_phi[i_0__][i_1__]", d_phi[i_0__][i_1__], 0);
                }
            }
            current_statement_begin__ = 359;
            validate_non_negative_index("d_gamma", "S", S);
            validate_non_negative_index("d_gamma", "logical_eq(obs_model, 1)", logical_eq(obs_model, 1));
            context__.validate_dims("data initialization", "d_gamma", "double", context__.to_vec(S,logical_eq(obs_model, 1)));
            d_gamma = std::vector<std::vector<double> >(S, std::vector<double>(logical_eq(obs_model, 1), double(0)));
            vals_r__ = context__.vals_r("d_gamma");
            pos__ = 0;
            size_t d_gamma_k_0_max__ = S;
            size_t d_gamma_k_1_max__ = logical_eq(obs_model, 1);
            for (size_t k_1__ = 0; k_1__ < d_gamma_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < d_gamma_k_0_max__; ++k_0__) {
                    d_gamma[k_0__][k_1__] = vals_r__[pos__++];
                }
            }
            size_t d_gamma_i_0_max__ = S;
            size_t d_gamma_i_1_max__ = logical_eq(obs_model, 1);
            for (size_t i_0__ = 0; i_0__ < d_gamma_i_0_max__; ++i_0__) {
                for (size_t i_1__ = 0; i_1__ < d_gamma_i_1_max__; ++i_1__) {
                    check_greater_or_equal(function__, "d_gamma[i_0__][i_1__]", d_gamma[i_0__][i_1__], 0);
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_predict_latent_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            validate_non_negative_index("F_KR", "num_pred", num_pred);
            validate_non_negative_index("F_KR", "S", S);
            validate_non_negative_index("F_KR", "num_comps", num_comps);
            std::vector<std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > > F_KR(S, std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >(num_comps, Eigen::Matrix<double, Eigen::Dynamic, 1>(num_pred)));
            stan::math::initialize(F_KR, DUMMY_VAR__);
            stan::math::fill(F_KR, DUMMY_VAR__);
            ...
            for (int is = 1; is <= S; ++is) {
                ...
                stan::model::assign(F_KR, 
                            stan::model::cons_list(stan::model::index_uni(is), stan::model::nil_index_list()), 
                            STAN_kr(get_base1(d_f_latent, is, "d_f_latent", 1), KX, KX_s, KX_ss, delta, pstream__), 
                            "assigning variable F_KR");
                }
            }
            // validate, write generated quantities
            current_statement_begin__ = 385;
            size_t F_KR_j_1_max__ = num_pred;
            size_t F_KR_k_0_max__ = S;
            size_t F_KR_k_1_max__ = num_comps;
            for (size_t j_1__ = 0; j_1__ < F_KR_j_1_max__; ++j_1__) {
                for (size_t k_1__ = 0; k_1__ < F_KR_k_1_max__; ++k_1__) {
                    for (size_t k_0__ = 0; k_0__ < F_KR_k_0_max__; ++k_0__) {
                        vars__.push_back(F_KR[k_0__][k_1__](j_1__));
                    }
                }
            }
        } catch (const std::exception& e) {
        ...
        for (size_t j_1__ = 0; j_1__ < F_KR_j_1_max__; ++j_1__) {
            for (size_t k_1__ = 0; k_1__ < F_KR_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < F_KR_k_0_max__; ++k_0__) {
                    ...
                    param_name_stream__ << "F_KR" << '.' << k_0__ + 1 << '.' << k_1__ + 1 << '.' << j_1__ + 1;
...
typedef model_predict_latent_namespace::model_predict_latent stan_model;
#ifndef USING_R
