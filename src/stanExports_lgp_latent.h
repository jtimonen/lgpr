...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(428, 10, "restart", "model_lgp_latent");
    reader.add_event(438, 20, "include", "_common/tdata.stan");
    reader.add_event(438, 0, "start", "_common/tdata.stan");
    reader.add_event(447, 9, "end", "_common/tdata.stan");
    reader.add_event(447, 21, "restart", "model_lgp_latent");
    reader.add_event(450, 24, "include", "_common/params.stan");
    reader.add_event(450, 0, "start", "_common/params.stan");
    reader.add_event(456, 6, "end", "_common/params.stan");
    reader.add_event(456, 25, "restart", "model_lgp_latent");
    reader.add_event(463, 32, "include", "_common/tparams.stan");
    reader.add_event(463, 0, "start", "_common/tparams.stan");
    reader.add_event(469, 6, "end", "_common/tparams.stan");
    reader.add_event(469, 33, "restart", "model_lgp_latent");
    reader.add_event(487, 51, "include", "_common/priors.stan");
    reader.add_event(487, 0, "start", "_common/priors.stan");
    reader.add_event(518, 31, "end", "_common/priors.stan");
    reader.add_event(518, 52, "restart", "model_lgp_latent");
    reader.add_event(550, 82, "end", "model_lgp_latent");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            check_greater_or_equal(function__, "obs_model", obs_model, 2);
            ...
            context__.validate_dims("data initialization", "y_int", "int", context__.to_vec(num_obs));
            y_int = std::vector<int>(num_obs, int(0));
            vals_i__ = context__.vals_i("y_int");
            pos__ = 0;
            size_t y_int_k_0_max__ = num_obs;
            for (size_t k_0__ = 0; k_0__ < y_int_k_0_max__; ++k_0__) {
                y_int[k_0__] = vals_i__[pos__++];
            }
            size_t y_int_i_0_max__ = num_obs;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(obs_model, 2))) {
                ...
                lp_accum__.add(binomial_logit_log(y_int, get_base1(y_num_trials, 1, "y_num_trials", 1), LOGIT_P));
                }
            } else if (as_bool(logical_eq(obs_model, 5))) {
                {
                ...
                lp_accum__.add(beta_binomial_log(y_int, get_base1(y_num_trials, 1, "y_num_trials", 1), aa, bb));
                }
            }
            }
        } catch (const std::exception& e) {
