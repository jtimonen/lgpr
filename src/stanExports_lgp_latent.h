...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(26, 9, "end", "_common/functions-utils.stan");
    reader.add_event(26, 4, "restart", "model_lgp_latent");
    reader.add_event(26, 4, "include", "_common/functions-prior.stan");
    reader.add_event(26, 0, "start", "_common/functions-prior.stan");
    reader.add_event(52, 26, "end", "_common/functions-prior.stan");
    reader.add_event(52, 5, "restart", "model_lgp_latent");
    reader.add_event(52, 5, "include", "_common/functions-kernels.stan");
    reader.add_event(52, 0, "start", "_common/functions-kernels.stan");
    reader.add_event(299, 247, "end", "_common/functions-kernels.stan");
    reader.add_event(299, 6, "restart", "model_lgp_latent");
    reader.add_event(302, 9, "include", "_common/data-general.stan");
    reader.add_event(302, 0, "start", "_common/data-general.stan");
    reader.add_event(353, 51, "end", "_common/data-general.stan");
    reader.add_event(353, 10, "restart", "model_lgp_latent");
    reader.add_event(353, 10, "include", "_common/data-covariates.stan");
    reader.add_event(353, 0, "start", "_common/data-covariates.stan");
    reader.add_event(359, 6, "end", "_common/data-covariates.stan");
    reader.add_event(359, 11, "restart", "model_lgp_latent");
    reader.add_event(359, 11, "include", "_common/data-priors.stan");
    reader.add_event(359, 0, "start", "_common/data-priors.stan");
    reader.add_event(369, 10, "end", "_common/data-priors.stan");
    reader.add_event(369, 12, "restart", "model_lgp_latent");
    reader.add_event(382, 25, "include", "_common/tdata.stan");
    reader.add_event(382, 0, "start", "_common/tdata.stan");
    reader.add_event(390, 8, "end", "_common/tdata.stan");
    reader.add_event(390, 26, "restart", "model_lgp_latent");
    reader.add_event(393, 29, "include", "_common/params.stan");
    reader.add_event(393, 0, "start", "_common/params.stan");
    reader.add_event(398, 5, "end", "_common/params.stan");
    reader.add_event(398, 30, "restart", "model_lgp_latent");
    reader.add_event(406, 38, "include", "_common/tparams.stan");
    reader.add_event(406, 0, "start", "_common/tparams.stan");
    reader.add_event(411, 5, "end", "_common/tparams.stan");
    reader.add_event(411, 39, "restart", "model_lgp_latent");
    reader.add_event(429, 57, "include", "_common/priors.stan");
    reader.add_event(429, 0, "start", "_common/priors.stan");
    reader.add_event(459, 30, "end", "_common/priors.stan");
    reader.add_event(459, 58, "restart", "model_lgp_latent");
    reader.add_event(497, 94, "end", "model_lgp_latent");
    return reader;
}
