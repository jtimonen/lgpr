...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(435, 17, "include", "_common/tdata.stan");
    reader.add_event(435, 0, "start", "_common/tdata.stan");
    reader.add_event(443, 8, "end", "_common/tdata.stan");
    reader.add_event(443, 18, "restart", "model_lgp_marginal");
    reader.add_event(446, 21, "include", "_common/params.stan");
    reader.add_event(446, 0, "start", "_common/params.stan");
    reader.add_event(451, 5, "end", "_common/params.stan");
    reader.add_event(451, 22, "restart", "model_lgp_marginal");
    reader.add_event(455, 26, "include", "_common/tparams.stan");
    reader.add_event(455, 0, "start", "_common/tparams.stan");
    reader.add_event(460, 5, "end", "_common/tparams.stan");
    reader.add_event(460, 27, "restart", "model_lgp_marginal");
    reader.add_event(464, 31, "include", "_common/priors.stan");
    reader.add_event(464, 0, "start", "_common/priors.stan");
    reader.add_event(494, 30, "end", "_common/priors.stan");
    reader.add_event(494, 32, "restart", "model_lgp_marginal");
    reader.add_event(514, 50, "end", "model_lgp_marginal");
    return reader;
}
