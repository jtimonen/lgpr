...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(68, 4, "restart", "model_lgp_marginal");
    ...
    reader.add_event(94, 5, "restart", "model_lgp_marginal");
    ...
    reader.add_event(310, 6, "restart", "model_lgp_marginal");
    ...
    reader.add_event(346, 10, "restart", "model_lgp_marginal");
    ...
    reader.add_event(361, 11, "restart", "model_lgp_marginal");
    ...
    reader.add_event(376, 12, "restart", "model_lgp_marginal");
    ...
    reader.add_event(390, 20, "restart", "model_lgp_marginal");
    ...
    reader.add_event(398, 24, "restart", "model_lgp_marginal");
    ...
    reader.add_event(407, 29, "restart", "model_lgp_marginal");
    ...
    reader.add_event(441, 34, "restart", "model_lgp_marginal");
    reader.add_event(460, 51, "end", "model_lgp_marginal");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "y", "vector_d", context__.to_vec(1,N));
            y = std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >(1, Eigen::Matrix<double, Eigen::Dynamic, 1>(N));
            vals_r__ = context__.vals_r("y");
            pos__ = 0;
            size_t y_j_1_max__ = N;
            size_t y_k_0_max__ = 1;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(is_likelihood_skipped, 0))) {
                ...
                lp_accum__.add(multi_normal_cholesky_log<propto__>(get_base1(y, 1, "y", 1), m0, cholesky_decompose(Ky)));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
