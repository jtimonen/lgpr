...
This vignette demonstrates the core functionality of the `lgpr` package. We
...
# Take prior draws and show corresponding input warping functions
wrp_draws <- stats::rlnorm(num_draws, mu_wrp, sigma_wrp)
ran <- range(testdata_002$diseaseAge, na.rm = TRUE)
lgpr:::plot_inputwarp(wrp_draws, seq(ran[1], ran[2], by = 1), alpha = 0.1)
```
