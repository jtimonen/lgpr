...
covariate effects. This and other tutorials focus on writing `R` code with the
package. To learn about the mathematical models, see the
...
The vignette ["Mathematical description of lgpr models"](https://cran.r-project.org/package=lgpr/vignettes/math.html)
